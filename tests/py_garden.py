...
with sync_playwright() as pw:
 ...
 p.locator('#navGarden').click();p.locator('.gardenSpot[data-kind=plot]').first.click();p.locator('.gardenPlantSubmit').first.click()
 ...
 for w,h in [(320,568),(390,844),(844,390)]:
  ...
  for lang in p.evaluate('Object.keys(L10N)'):
   ...
   assert p.locator('#gardenPlots .gardenCropChoices').count()==3
