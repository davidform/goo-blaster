...
if [ "${1:-}" = "quick" ]; then
  ...
  PY="py_50levels py_ab_base py_audit_fixes py_balance py_boss_skin py_boss_time \
      ...
      py_shell py_lifeline py_soft_ui py_audio_quality py_l10n_context py_revive_collision py_dash_protection py_visible_target py_range_reach py_range_ui py_report_export py_field_ui py_enemy_weight"
