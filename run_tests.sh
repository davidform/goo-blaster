...
if [ "${1:-}" = "quick" ]; then
  PY="py_test9 py_ab_base py_bullet_density py_i18n py_cjk_scan py_v0927 py_native_store py_save_code py_v0930"
  JS=""
else
  PY="py_50levels py_ab_base py_audit_fixes py_balance py_boss_skin py_boss_time \
      ...
      py_shell py_lifeline py_soft_ui py_audio_quality py_l10n_context py_revive_collision py_dash_protection py_visible_target py_range_reach py_range_ui py_report_export py_field_ui py_enemy_weight py_shop_pacing py_world_story py_upgrade_queue py_fire_trail py_chapter_health py_ordinary_shot_pace py_nuke_cinematic py_readability py_clay_depth py_nuke_icon py_boss_solid py_dash_cadence py_build_slots py_garden py_garden_design py_garden_context py_garden_tabs py_garden_world py_garden_quest py_garden_timer py_garden_village py_garden_festival py_garden_feedback py_garden_level_timer py_music_scenes py_town_home"
