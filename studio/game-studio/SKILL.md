...
- For player-facing releases, store assets or significant experience changes, use [paid-game quality review](references/market-quality.md). Review technical correctness, player experience and commercial presentation separately; passing tests or updating files alone is not completion. Reuse the user's established commercial intent instead of requesting repeated quality instructions.
